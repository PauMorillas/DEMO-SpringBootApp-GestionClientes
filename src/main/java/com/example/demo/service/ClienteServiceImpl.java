...
public class ClienteServiceImpl implements ClienteService {
	...
	public List<ClienteDTO> findAll() {
		 ...
		 * 
		 * for (int i = 0; i < listaClientes.size(); i++) { Cliente cliente =
		 * listaClientes.get(i); ClienteDTO clienteDTO =
		 * ClienteDTO.convertToDTO(cliente); listaClientesDTO.add(clienteDTO); }
		 */
